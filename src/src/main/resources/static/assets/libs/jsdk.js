(function (exports) {
    ...
    var IString = (function () {
        ...
        IString.padLeft = function (str, size, padStr) {
            ...
            var paddingString = new String(), len = Math.floor((size - str.length) / padStr.length),
    ...
    var IDate = (function () {
        ...
        IDate.format = function (date, pattern) {
            ...
            var year = date.getFullYear(), month = date.getMonth() + 1, date2 = date.getDate(), hours = date.getHours(),
        ...
        IDate.getWeekOfMonth = function (date) {
            var year = date.getFullYear(), month = date.getMonth(), first = new Date(year, month, 1).getDate(),
                last = 32 - new Date(year, month, 32).getDate();
            return Math.ceil((first + last) / 7);
        };
        IDate.getWeekOfYear = function (date) {
            var year = date.getFullYear(), beginDay = new Date(year, 0, 1).getDay(),
