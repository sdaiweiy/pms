...
layui.define(['jquery'],function (exports) {
    ...
    t.render = function (option,callback) {
        ...
        option.plugins = isset(option.plugins) ? option.plugins : 'print preview searchreplace autolink fullscreen image link media codesample table charmap hr advlist lists wordcount imagetools indent2em';
